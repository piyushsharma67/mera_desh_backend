...
func (r *ServiceStruct) InsertUserFCMInDB(ctx context.Context, fcmToken string) (*database.UserFcmToken, error) {
	...
	if err !=nil{
		if errors.Is(err,pgx.ErrNoRows){
			...
			db_user,err:=r.repository.InsertUserFcmById(ctx,createUserFcmToken)
